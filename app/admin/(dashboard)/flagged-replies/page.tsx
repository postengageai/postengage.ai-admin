...
export default function FlaggedRepliesPage() {
  ...
  return (
    <div>
      <AdminPageHeader title="Flagged Replies" description="Review and manage flagged AI replies" />
              ...
              <TableBody>
                {replies.map((reply) => (
                  <TableRow key={reply._id || reply.id}>
                    ...
                    <TableCell className="text-sm">{reply.reason || 'N/A'}</TableCell>
                    <TableCell>
                      <StatusBadge status={reply.status || 'pending'} />
                    </TableCell>
                    <TableCell className="text-sm text-muted-foreground">
                      {reply.created_at ? format(new Date(reply.created_at), 'MMM d, yyyy') : '-'}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
