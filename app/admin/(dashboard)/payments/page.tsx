...
export default function PaymentsPage() {
  ...
  if (error) {
    return (
      <div>
        <AdminPageHeader title="Payments" description="View and manage payments" />
  ...
  return (
    <div>
      <AdminPageHeader title="Payments" description="View and manage customer payments" />
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <p className="text-sm text-muted-foreground">Total: {pagination.total} payments</p>
